...
const AddPost = () => {
  ...
  const myImageUrl = cld.image().toURL();
              ...
              <DialogContent className="max-h-screen overflow-y-scroll">
                <DialogHeader>
                  ...
                  <DialogDescription>
                      ...
                      <div key={index}>
                        ...
                        <div>
                          ...
                          <div className="flex space-x-2 items-center">
                            <Input
                              ...
                              onChange={(e) => handlePostChange(index, 'durationWeekStartHour', e.target.value)}
                              placeholder="HH"
                              required
                            />
                            <span>h</span>
                            <Input
                              ...
                              onChange={(e) => handlePostChange(index, 'durationWeekStartMinute', e.target.value)}
                              placeholder="MM"
                              required
                            />
                            <span>à</span>
                            <Input
                              ...
                              onChange={(e) => handlePostChange(index, 'durationWeekEndHour', e.target.value)}
                              placeholder="HH"
                              required
                            />
                            <span>h</span>
                            <Input
                              ...
                              onChange={(e) => handlePostChange(index, 'durationWeekEndMinute', e.target.value)}
                              placeholder="MM"
                              required
                            />
                          </div>
                        ...
                        <div>
                          ...
                          <div className="flex space-x-2 items-center">
                            <Input
                              ...
                              onChange={(e) => handlePostChange(index, 'durationSaturdayStartHour', e.target.value)}
                              placeholder="HH"
                              required
                            />
                            <span>h</span>
                            <Input
                              ...
                              onChange={(e) => handlePostChange(index, 'durationSaturdayStartMinute', e.target.value)}
                              placeholder="MM"
                              required
                            />
                            <span>à</span>
                            <Input
                              ...
                              onChange={(e) => handlePostChange(index, 'durationSaturdayEndHour', e.target.value)}
                              placeholder="HH"
                              required
                            />
                            <span>h</span>
                            <Input
                              ...
                              onChange={(e) => handlePostChange(index, 'durationSaturdayEndMinute', e.target.value)}
                              placeholder="MM"
                              required
                            />
                          </div>
                        ...
                        <div>
                          ...
                          <Input
                            ...
                            type="number"
                            value={post.stock}
                            onChange={(e) => handlePostChange(index, 'stock', e.target.value)}
                            placeholder="Stock"
                            required
                          />
                        </div>
                    ...
                    <br />
                    <Button className="flex items-end justify-end" type="submit" onClick={handleSubmit}>
                      Ajouter
                    </Button>
                  </DialogDescription>
                </DialogHeader>
