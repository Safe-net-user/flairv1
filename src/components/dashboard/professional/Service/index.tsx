...
export default function ServicesTab() {
  ...
  // Appeler fetchServices lors du montage du composant
  useEffect(() => {
    fetchServices();
  }, []);
    ...
    <TabsContent value="services" className="space-y-4">
      ...
      <div className="flex items-end justify-start space-y-4">
        ...
        <button className="bg-black text-white flex items-center rounded text-lg cursor-pointer" style={{ padding: '6px' }}>
            <img className='flex items-center' style={{ marginRight: '10px', marginTop: '-5px', marginBottom: '-5px' }} src="/iconService/plus-2.svg" />
            Ajouter un service
          </button>
        </Link>
      </div>
